...
) -> HTTPValidationError | PaginatedResponseCategory | None:
    if response.status_code == 200:
        response_200 = PaginatedResponseCategory.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PaginatedResponseCategory]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | PaginatedResponseCategory
    """
