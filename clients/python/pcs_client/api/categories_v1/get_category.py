...
) -> Category | PartialCategory | HTTPValidationError | None:
    if response.status_code == 200:

        def _parse_response_200(data: object) -> Category | PartialCategory:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_type_0 = Category.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            response_200_type_1 = PartialCategory.from_dict(data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Category | PartialCategory | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Category | PartialCategory | HTTPValidationError
    """
