...
T = TypeVar("T", bound="PaginatedResponseProductVariant")


@_attrs_define
class PaginatedResponseProductVariant:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ProductVariant.from_dict(items_item_data)
        ...
        paginated_response_product_variant = cls(
            items=items,
            start_cursor=start_cursor,
            end_cursor=end_cursor,
            has_next=has_next,
        ...
        paginated_response_product_variant.additional_properties = d
        return paginated_response_product_variant
