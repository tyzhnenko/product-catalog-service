...
T = TypeVar("T", bound="PaginatedResponsePartialBundle")


@_attrs_define
class PaginatedResponsePartialBundle:
    """
    Attributes:
        items (list[PartialBundle]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = PartialBundle.from_dict(items_item_data)
        ...
        paginated_response_partial_bundle = cls(
            items=items,
            start_cursor=start_cursor,
            end_cursor=end_cursor,
            has_next=has_next,
        ...
        paginated_response_partial_bundle.additional_properties = d
        return paginated_response_partial_bundle
