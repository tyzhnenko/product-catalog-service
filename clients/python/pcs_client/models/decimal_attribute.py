...
T = TypeVar("T", bound="DecimalAttribute")
...
class DecimalAttribute:
    ...
    Attributes:
        ...
        value (float | str): Decimal value represented as a float in string format
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        decimal_attribute = cls(
            name=name,
            value=value,
            type_=type_,
        )

        decimal_attribute.additional_properties = d
