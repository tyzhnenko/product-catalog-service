...
T = TypeVar("T", bound="PaginatedResponseStore")


@_attrs_define
class PaginatedResponseStore:
    """
    Attributes:
        items (list[Store]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = Store.from_dict(items_item_data)
        ...
        paginated_response_store.additional_properties = d
        return paginated_response_store
