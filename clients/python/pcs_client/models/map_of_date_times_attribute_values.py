...
T = TypeVar("T", bound="MapOfDateTimesAttributeValues")


@_attrs_define
class MapOfDateTimesAttributeValues:
    """Map of datetime values"""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        map_of_date_times_attribute_values = cls()
        ...
        map_of_date_times_attribute_values.additional_properties = additional_properties
        return map_of_date_times_attribute_values
