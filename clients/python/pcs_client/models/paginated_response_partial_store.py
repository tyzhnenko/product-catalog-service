...
T = TypeVar("T", bound="PaginatedResponsePartialStore")


@_attrs_define
class PaginatedResponsePartialStore:
    """
    Attributes:
        items (list[PartialStore]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = PartialStore.from_dict(items_item_data)
        ...
        paginated_response_partial_store = cls(
            items=items,
            start_cursor=start_cursor,
            end_cursor=end_cursor,
            has_next=has_next,
        ...
        paginated_response_partial_store.additional_properties = d
        return paginated_response_partial_store
