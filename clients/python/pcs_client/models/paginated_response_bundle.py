...
T = TypeVar("T", bound="PaginatedResponseBundle")


@_attrs_define
class PaginatedResponseBundle:
    """
    Attributes:
        items (list[Bundle]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = Bundle.from_dict(items_item_data)
        ...
        paginated_response_bundle.additional_properties = d
        return paginated_response_bundle
