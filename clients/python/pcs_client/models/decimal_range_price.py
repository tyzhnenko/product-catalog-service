...
T = TypeVar("T", bound="DecimalRangePrice")


@_attrs_define
class DecimalRangePrice:
    """
    Attributes:
        name (str): Name of the attribute
        min_value (float | str): Price represented as a decimal in string format
        max_value (float | str): Price represented as a decimal in string format
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        decimal_range_price.additional_properties = d
        return decimal_range_price
