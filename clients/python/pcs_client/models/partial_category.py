...
T = TypeVar("T", bound="PartialCategory")


@_attrs_define
class PartialCategory:
    """Category information, limited to the fields requested via the `fields` query param
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partial_category.additional_properties = d
