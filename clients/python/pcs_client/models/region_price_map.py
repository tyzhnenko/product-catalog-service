...
T = TypeVar("T", bound="RegionPriceMap")


@_attrs_define
class RegionPriceMap:
    """Mapping of region identifiers to their corresponding PriceMap"""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        region_price_map.additional_properties = additional_properties
