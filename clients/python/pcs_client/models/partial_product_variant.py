...
T = TypeVar("T", bound="PartialProductVariant")


@_attrs_define
class PartialProductVariant:
    """Product variant information, limited to the fields requested via the `fields` query param
    ...
    Attributes:
        ...
        jan (None | str | Unset):
        isbn (None | str | Unset):
        options (list[VariantOption] | None | Unset):
    ...
    options: list[VariantOption] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_options(data: object) -> list[VariantOption] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for componentsschemas_variant_options_item_data in _options_type_0:
                    componentsschemas_variant_options_item = VariantOption.from_dict(
                        componentsschemas_variant_options_item_data
                    )

                    options_type_0.append(componentsschemas_variant_options_item)

                return options_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(list[VariantOption] | None | Unset, data)
        ...
        partial_product_variant.additional_properties = d
        return partial_product_variant
